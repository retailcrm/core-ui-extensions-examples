...
### 11. Реестр возвратов `cases/returnsModule`

Page-case для раздела `Продажи`, публикуемый через `pages` в `extensionrc.json`.
Демонстрирует страницу реестра возвратов с фильтрами, пагинацией, query string и шторкой создания/редактирования.

Подробности по публикации, URL страницы и устройству кейса: [cases/returnsModule/README.md](cases/returnsModule/README.md).

### 12. Канбан задач CRM `cases/tasksModule`

Page-case с kanban-доской задач для пользователей CRM.
Демонстрирует использование `RemoteSortableContainer`, `RemoteSortableItem` и `RemoteDragHandle` из `@omnicajs/vue-remote/remote`.

Подробности по публикации, URL страницы и устройству кейса: [cases/tasksModule/README.md](cases/tasksModule/README.md).
